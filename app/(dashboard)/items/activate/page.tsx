...
function ActivateForm() {
  ...
  // Keep code state updated if search parameter changes
  useEffect(() => {
    if (initialCode) {
      setCode(initialCode);
    }
...
export default function ActivatePage() {
  return (
    <div className="max-w-lg">
      ...
      <Suspense fallback={
        <div className="rounded-2xl bg-surface-elevated border border-border/50 p-6 flex items-center justify-center h-[300px]">
